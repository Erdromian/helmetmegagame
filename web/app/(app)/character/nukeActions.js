...
async function armNukeImpl() {
  ...
  if (state?.game?.nukeDetonatedTurn != null) throw new UserError("It's already gone off.");
  if (state?.nukeArmedTurn != null) throw new UserError("It's already counting down.");
